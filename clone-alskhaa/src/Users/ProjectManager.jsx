...
const ProjectManager = () => {
    ...
    const fetchProjectManagerUsers = async () => {
        try {
            const query = `?page=${page}&limit=${limit}&role=project_manager`
            ...
            if (res.success) {
                ...
                toast.error('Failed to fetch project manager users', toastStyle)
            }
        } catch (err) {
            console.error('API Error:', err);
            toast.error(err.response?.data?.message || 'Failed to fetch project manager users', toastStyle)
        }
    }
                                    ...
                                    <CTableRow key={user._id || index}>
                                        ...
                                        <CTableDataCell>
                                            <ActionUser
                                                ...
                                                onUpdate={fetchProjectManagerUsers}
                                            />
                                        </CTableDataCell>
                                    </CTableRow>
                                ))}
