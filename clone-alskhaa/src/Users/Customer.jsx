...
const Customer = () => {
    ...
    const fetchCustomerUsers = async () => {
        try {
            const query = `?page=${page}&limit=${limit}&role=customer`
            ...
            if (res.success) {
                ...
                toast.error('Failed to fetch customer users', toastStyle)
            }
        } catch (err) {
            console.error('API Error:', err);
            toast.error(err.response?.data?.message || 'Failed to fetch customer users', toastStyle)
        }
    }
